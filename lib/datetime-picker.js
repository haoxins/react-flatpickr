...
const mergeHooks = (inputOptions, props) => {
    ...
    hooks.forEach((hook) => {
        if (props[hook]) {
            if (inputOptions[hook] &&
                !Array.isArray(inputOptions[hook])) {
...
const DateTimePicker = (_a) => {
    var { defaultValue, options = {}, value, children, render, onCreate, onDestroy } = _a, props = __rest(_a, ["defaultValue", "options", "value", "children", "render", "onCreate", "onDestroy"]);
    ...
    (0, react_1.useEffect)(() => {
        const createFlatpickrInstance = () => {
            let mergedOptions = Object.assign({ onClose: () => {
                    var _a;
                    ((_a = nodeRef.current) === null || _a === void 0 ? void 0 : _a.blur) && nodeRef.current.blur();
                } }, options);
            if (!mergedOptions)
                return;
    ...
    (0, react_1.useEffect)(() => {
        ...
        if (flatpickrRef.current) {
            ...
            for (let index = optionsKeys.length - 1; index >= 0; index--) {
                ...
                if ((optionValue === null || optionValue === void 0 ? void 0 : optionValue.toString()) !==
                    ((_a = flatpickrRef.current.config[key]) === null || _a === void 0 ? void 0 : _a.toString())) {
    ...
    return options.wrap ? (react_1.default.createElement("div", Object.assign({}, props, { ref: handleNodeChange }), children)) : (react_1.default.createElement("input", Object.assign({}, props, { defaultValue: defaultValue, ref: handleNodeChange })));
};
