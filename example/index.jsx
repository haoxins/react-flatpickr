  ...
  render() {
    ...
    return (
      <main>
        ...
        />
        <Flatpickr data-enable-time defaultValue="2016-11-11 11:11" onChange={this.state.handler} />
        <button
          type="button"
          onClick={() => {
            this.setState((state) => ({
        ...
        <Flatpickr data-enable-time value={v} onChange={(_, str) => console.info(str)} />
        <Flatpickr value={v} options={{minDate: '2016-11-01'}} onChange={(_, str) => console.info(str)} />
        <Flatpickr
          value={range}
          options={{mode: 'range'}}
          onChange={(dates, str) => {
        ...
        <Flatpickr value={v} options={{wrap: true}} onChange={(_, str) => console.info(str)}>
